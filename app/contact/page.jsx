...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+994) 50 610 25 99"
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "aygunaghalarova24@gmail.com"
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
        ...
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl" action="">
              ...
              <p className="text-white/60">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto dolore rerum exercitationem quaerat perspiciatis laudantium natus quia corporis placeat labore?</p>
              {/* input */}
